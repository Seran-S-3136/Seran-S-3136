...
class SeranS:
    def __init__(self):
        ...
        self.degree = "B.Tech, AI & Data Science @ KSRCT"
        self.role = "Software Engineer Intern @ ABB"

        self.stack = [
            "React.js", "Next.js", "Node.js", "Express.js",
            "Python (Flask)", "TypeScript", "Flutter"
        ]

        self.currentlyLearning = [
            "Advanced MLOps", "Cloud-Native Architecture",
            "System Design"
        ]

        self.funFact = "I turn flaky test suites into reliable ones 🔧"

    def motto(self):
        return "Ship code that's validated, reliable, and production-ready by design."
...
| **Quality Engineering & Data** | ![PyTest](https://img.shields.io/badge/PyTest-0A9EDC?style=flat-square&logo=pytest&logoColor=white) ![Playwright](https://img.shields.io/badge/Playwright-2EAD33?style=flat-square&logo=playwright&logoColor=white) ![Robot Framework](https://img.shields.io/badge/Robot_Framework-000000?style=flat-square&logo=robotframework&logoColor=white) ![NumPy](https://img.shields.io/badge/NumPy-013243?style=flat-square&logo=numpy&logoColor=white) ![Pandas](https://img.shields.io/badge/Pandas-150458?style=flat-square&logo=pandas&logoColor=white) ![Scikit-learn](https://img.shields.io/badge/Scikit--learn-F7931E?style=flat-square&logo=scikitlearn&logoColor=white) |

## 📊 GitHub Stats

<div align="center">

[![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Seran-S-3136&show_icons=true&theme=tokyonight&hide_border=true&include_all_commits=true&count_private=true&bg_color=0d1117&title_color=70a5fd&icon_color=bf91f3&text_color=c9d1d9&border_radius=10)](https://github.com/Seran-S-3136)

[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Seran-S-3136&layout=compact&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=70a5fd&text_color=c9d1d9&langs_count=8&border_radius=10)](https://github.com/Seran-S-3136)

![GitHub Streak](https://streak-stats.demolab.com?user=Seran-S-3136&theme=tokyonight-duo&hide_border=true&background=0D1117&ring=70A5FD&fire=BF91F3&currStreakLabel=70A5FD&sideLabels=38BDAE&dates=8B949E&currStreakNum=C9D1D9&sideNums=C9D1D9&stroke=0D1117&border_radius=10)

![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=Seran-S-3136&theme=tokyo-night&bg_color=0d1117&color=70a5fd&line=bf91f3&point=38bdae&area=true&hide_border=true)
...
![Trophies](https://github-profile-trophy.vercel.app/?username=Seran-S-3136&theme=tokyonight&no-frame=true&no-bg=true&row=1&column=7&margin-w=4)
...
- Engineered and maintained automated test frameworks for web and API applications, boosting regression coverage by **30%** across 3 product pipelines.
- Spearheaded migration and stabilization of **5+ API automation suites**, cutting flaky test execution by **40%** and improving reliability across cloud-based CI/CD environments.
- Streamlined configuration validation workflows by integrating test execution into Azure DevOps cloud pipelines, reducing build validation time by **25%**.

</details>

<details>
<summary><b>SkySphere Technologies Pvt. Ltd. — Software Developer Intern | Feb 2025 – May 2025 | Tiruchengode, India</b></summary>
<br>

> `Flutter` `Firebase` `React.js` `NoSQL`
...
- Designed and launched a responsive, UI/UX-focused E-Commerce Admin Dashboard using React.js and Firebase, consolidating product management, user oversight, and operational workflows into a single web application.
...
```text
🧱 MLOps            → Experiment Tracking, Model Versioning, Drift Monitoring
☁️ Cloud Architecture → Cloud-Native Design, Scalable Deployments
🏗️ System Design     → Distributed Systems, API Design at Scale
```
